...
<!--                <div class="col-xs-4 col-sm-4 secondGrey"><p> <?php //print $_SESSION["numCom"];  ?></p></div>-->
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 gras centrerTexte"><p>TOTAL &nbsp;&nbsp; <span class="secondGrey nonGras"><?php print $_SESSION['tot']; ?> € </span></p></div>
<!--                <div class="col-xs-4 col-sm-4 secondGrey"><p> <?php //print $_SESSION["numCom"];  ?></p></div>-->
            </div>

            <div class="row">
                <div class="col-sm-12">
                    <a href="../classyLee/pages/printCommande.php?id=<?php print $_SESSION["numCom"]; ?>" target="_blank" class="black centrerTexte">
                        Imprimer la facture
                    </a>
                </div>
            </div>
